  ...
  return (
    <div className="flex flex-wrap w-full p-4">
      <Card className="w-full p-4">
        ...
        <CardDescription>
          This is a production-like application built for educational purposes. Technologies and Techniques used were
          chosen to learn on to use them or how well they worked in a production environment. Feel free to look through
          the repo to learn how this project works.
        </CardDescription>
        <CardContent className="flex flex-col gap-2 pt-3">
          ...
          <a className="flex w-48 justify-between" href="https://www.linkedin.com/in/ChadRStewart" target="_blank">
            <div className="flex gap-2">
